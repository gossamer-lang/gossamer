...
const SPECS: &[Spec] = &[
    ...
    spec("feature-testing-examples/unsigned_shift_compare_crc.gos"),
    spec("feature-testing-examples/push_substring_append.gos"),
    spec("feature-testing-examples/field_iteration_holder_calls.gos"),
    spec("feature-testing-examples/unsigned_high_bit_sources.gos"),
    spec("feature-testing-examples/slice_results_char_index.gos"),
    spec("feature-testing-examples/field_iteration_callee_shapes.gos"),
    spec("feature-testing-examples/static_values_across_threads.gos"),
    spec("feature-testing-examples/push_mixed_width_aggregates.gos"),
    spec("feature-testing-examples/map_table_values_owned.gos"),
    spec("feature-testing-examples/map_vec_values_copies.gos"),
    spec("feature-testing-examples/unsigned_word_float_casts.gos"),
    spec("feature-testing-examples/narrow_unary_wrap.gos"),
    spec("feature-testing-examples/float_remainder.gos"),
    spec("feature-testing-examples/range_pattern_limit_bounds.gos"),
    spec("feature-testing-examples/sync_handles_typed.gos"),
    spec("feature-testing-examples/flat_map_iterator_callbacks.gos"),
    spec("feature-testing-examples/runtime_handles_typed.gos"),
    Spec {
        stdin: b"alpha\nbeta\ngamma\n",
        ..spec("feature-testing-examples/bufio_scanner_next.gos")
    },
    spec("feature-testing-examples/or_insert_field_path_write.gos"),
    spec("feature-testing-examples/mut_pattern_bindings_own_value.gos"),
    spec("feature-testing-examples/mut_ref_payload_enum_param.gos"),
    spec("feature-testing-examples/container_elements_owned.gos"),
    ...
    spec("feature-testing-examples/regex_find_all_count.gos"),
    spec("feature-testing-examples/rc_elision.gos"),
    spec("feature-testing-examples/rc_guarded_walk_holder.gos"),
    spec("feature-testing-examples/rc_ref_receiver_copy_holder.gos"),
