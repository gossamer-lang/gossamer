...
pub use emit::{
    ...
    compile_with_fallback_at_path, loop_idiom_disabled, pgo_mode, render_ir_to_string,
    reproducible_enabled, set_cache_dir, set_debug_info, set_opt_profile, set_pgo_mode,
    set_race_instrumentation, set_reproducible, set_source_positions, set_static_musl_link,
